        ...
        <div className="relative z-10 mx-auto max-w-[1200px]">
          ...
          <div className="mx-auto max-w-[760px]">
            ...
            <p className="mb-6 leading-relaxed text-silver-haze">
              ...
              <em>&ldquo;A Logical Calculus of the Ideas Immanent in Nervous Activity.&rdquo;</em>{' '}
              The paper introduced a mathematical model of neurons as simple logical elements,
              capable of implementing arbitrary Boolean functions when connected into networks.
            </p>
          ...
          <div className="mx-auto max-w-[760px]">
            ...
            <p className="mb-6 leading-relaxed text-silver-haze">
              ...
              <em>&ldquo;Computing Machinery and Intelligence&rdquo;</em> in the journal{' '}
              <em>Mind</em>. It is widely regarded as the first systematic attempt to reformulate
              the question &ldquo;Can machines think?&rdquo; in operational, rather than purely
              philosophical, terms.
            </p>
            <p className="mb-6 leading-relaxed text-silver-haze">
              Turing introduced the &ldquo;imitation game,&rdquo; later known as the Turing test.
              The original setup involves three participants: a man, a woman, and an interrogator
              who is isolated from the other two and communicates with them only in writing, trying
              to determine which is which. Turing proposed replacing one human participant with a
            ...
            <p className="mb-10 leading-relaxed text-silver-haze">
              ...
              prove that machines think; he shifted the burden of proof, showing the question could
              be investigated empirically through computation and behaviour rather than settled by
              definition alone.
            </p>
          </div>
          ...
          <div className="mx-auto max-w-[760px]">
            ...
            <p className="mb-6 leading-relaxed text-silver-haze">
              The Dartmouth Summer Research Project on Artificial Intelligence ran from 18 June to
              17 August 1956 at Dartmouth College. It was initiated by a proposal, dated 31 August
              1955, written by John McCarthy, Marvin Minsky, Nathaniel Rochester, and Claude
              Shannon. The proposal&rsquo;s central hypothesis: &ldquo;every aspect of learning or
              any other feature of intelligence can in principle be so precisely described that a
              machine can be made to simulate it.&rdquo;
            </p>
            <p className="mb-6 leading-relaxed text-silver-haze">
              The Dartmouth workshop did not originate the ideas behind it &mdash; the
              McCulloch-Pitts model, Turing&rsquo;s own analysis of computable numbers, and early
              game-playing and logic programs already existed. Its real contribution was conceptual
              and institutional: it brought researchers from mathematics, computer science,
              neurophysiology, psychology, and engineering together under a shared label, and
              articulated a common research agenda.
            </p>
            <p className="mb-10 leading-relaxed text-silver-haze">
              Participants included John McCarthy, Marvin Minsky, Allen Newell, Herbert Simon,
              Arthur Samuel, Oliver Selfridge, and Ray Solomonoff, among others. Later
              historiography has called it the &ldquo;Constitutional Convention of AI&rdquo; &mdash;
              not because it generated every foundational idea, but because it established the
              field&rsquo;s disciplinary boundaries, terminology, and collective identity.
            </p>
          </div>
          ...
          <div className="mx-auto max-w-[760px]">
            ...
            <ul className="mb-12 space-y-3 border-l-2 border-mint-signal pl-6 leading-relaxed text-silver-haze">
              ...
              <li>
                <strong className="text-frost">1955</strong> &mdash; McCarthy, Minsky, Rochester,
                and Shannon circulate the Dartmouth proposal.
              </li>
              <li>
                <strong className="text-frost">1956</strong> &mdash; The Dartmouth workshop
                convenes, consolidating prior work under the name &ldquo;artificial
                intelligence.&rdquo;
              </li>
            </ul>

            <p className="mb-16 text-lg leading-relaxed text-silver-haze">
              This sequence is the convergence: from an abstract model of neural computation,
              through an operational criterion for machine intelligence, to an institutionalised
              research field with a shared vocabulary and agenda.
            </p>

            <div className="border-t border-border-subtle pt-6">
              <p className="font-caption mb-4 text-silver-haze">SOURCES</p>
              <div className="flex">
                {sources.map((s, i) => (
                  <a
                    key={s.url}
                    ...
                    title={s.name}
                    aria-label={s.name}
                    style={{ marginLeft: i === 0 ? 0 : '-10px', zIndex: sources.length - i }}
                    className="relative flex h-10 w-10 items-center justify-center rounded-full border-2 border-deep-obsidian bg-surface-tonal text-silver-haze transition-transform hover:z-20 hover:-translate-y-1 hover:border-mint-signal"
                  >
                    {/* eslint-disable-next-line @next/next/no-img-element -- external, unknown-dimension favicon. Deliberately simpler than trajectory-logo.tsx's own full 3-source fallback chain: only 6 well-known, high-authority domains here, a single Google favicon request is a reasonable, honest scope for this specific compact row */}
                    <img
