...
export interface SignalFeedback {
  ...
  feedback_event: 'viewed' | 'shared' | 'flagged_wrong' | 'flagged_important' | 'cited' | 'superseded' | 'promoted' | 'demoted'
...
export function isPromotionEligible(
  signal: Pick<Signal, 'signal_score' | 'confidence_score' | 'status' | 'validation_flags' | 'created_at'>
): boolean {
